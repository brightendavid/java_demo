...
public class managerInfoModifier {
	...
	public static void main(String[] args) {
		try {
			managerInfoModifier dialog = new managerInfoModifier();
	...
	public managerInfoModifier() {
		...
		JLabel nunberLabel = new JLabel("学号：");
